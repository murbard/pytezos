...
from pytezos import ContractInterface, NonFungibleTokenImpl
...
class NftContractTest(TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.ci = ContractInterface.create_from(join(dirname(__file__), 'nft.tz'), factory=NonFungibleTokenImpl)
