...
from pytezos.operation.forge import encode_reveal, encode_transaction, encode_origination, encode_delegation
...
class TestOperationEncoding(TestCase):
    ...
    def test_reveal(self):
        ...
        self.assertEqual(expected, encode_reveal(reveal))
    ...
    def test_transaction(self):
        ...
        self.assertEqual(expected, encode_transaction(transaction))
    ...
    def test_origination(self):
        ...
        self.assertEqual(expected, encode_origination(origination))
    ...
    def test_delegation(self):
        ...
        self.assertEqual(expected, encode_delegation(delegation))
