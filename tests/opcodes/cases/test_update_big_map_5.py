...
class OpcodeTestupdate_big_map_5(TestCase):
    ...
    def test_opcode_update_big_map_5(self):
        ...
        res = self.i.execute('RUN { Elt "3" (Some "three") } (Pair { Elt "1" "one" ; Elt "2" "two" } Unit)')
        self.assertTrue(res['success'])
