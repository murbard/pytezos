...
class MichelsonCodingTestKT1TEy(TestCase):
    ...
    def test_michelson_parse_code_KT1TEy(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/code_KT1TEy.tz'))
    ...
    def test_michelson_parse_storage_KT1TEy(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/storage_KT1TEy.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooSJeE(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ooSJeE.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opKSUG(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_opKSUG.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ootApt(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ootApt.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo7dXA(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_oo7dXA.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opJMM9(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_opJMM9.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_op6KiD(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_op6KiD.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onkFnb(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_onkFnb.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onoXYv(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_onoXYv.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_onoXYv.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_onoXYv(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_onoXYv.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_onoXYv.json'), 
    ...
    def test_michelson_inverse_parameter_onoXYv(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_onoXYv.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooTTEc(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ooTTEc.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ooTTEc.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooTTEc(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ooTTEc.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ooTTEc.json'), 
    ...
    def test_michelson_inverse_parameter_ooTTEc(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_ooTTEc.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_oo7x1P(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_oo7x1P.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_oo7x1P.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_oo7x1P(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_oo7x1P.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_oo7x1P.json'), 
    ...
    def test_michelson_inverse_parameter_oo7x1P(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1TEyRcaJi39jgj4Uuz7VD6Jmn6CDDADv4x/parameter_oo7x1P.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
