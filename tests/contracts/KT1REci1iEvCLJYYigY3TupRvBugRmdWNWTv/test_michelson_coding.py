...
class MichelsonCodingTestKT1REc(TestCase):
    ...
    def test_michelson_parse_parameter_op2bPB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_op2bPB.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_op2bPB.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_op2bPB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_op2bPB.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_op2bPB.json'), 
    ...
    def test_michelson_inverse_parameter_op2bPB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_op2bPB.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ong9NW(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_ong9NW.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_ong9NW.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ong9NW(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_ong9NW.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_ong9NW.json'), 
    ...
    def test_michelson_inverse_parameter_ong9NW(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1REci1iEvCLJYYigY3TupRvBugRmdWNWTv/parameter_ong9NW.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
