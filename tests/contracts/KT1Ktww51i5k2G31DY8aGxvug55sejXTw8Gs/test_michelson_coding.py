...
class MichelsonCodingTestKT1Ktw(TestCase):
    ...
    def test_michelson_parse_parameter_oorJZy(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_oorJZy.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_oorJZy.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_oorJZy(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_oorJZy.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_oorJZy.json'), 
    ...
    def test_michelson_inverse_parameter_oorJZy(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_oorJZy.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ontnPQ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ontnPQ.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ontnPQ.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ontnPQ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ontnPQ.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ontnPQ.json'), 
    ...
    def test_michelson_inverse_parameter_ontnPQ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ontnPQ.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooRnQh(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ooRnQh.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ooRnQh.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooRnQh(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ooRnQh.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ooRnQh.json'), 
    ...
    def test_michelson_inverse_parameter_ooRnQh(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ktww51i5k2G31DY8aGxvug55sejXTw8Gs/parameter_ooRnQh.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
