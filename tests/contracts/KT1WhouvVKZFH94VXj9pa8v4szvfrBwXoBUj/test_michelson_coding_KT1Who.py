...
class MichelsonCodingTestKT1Who(TestCase):
    ...
    def test_michelson_parse_code_KT1Who(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/code_KT1Who.tz'))
    ...
    def test_michelson_parse_storage_KT1Who(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/storage_KT1Who.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oozD2D(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_oozD2D.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opECec(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_opECec.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooaH79(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_ooaH79.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oonu1M(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_oonu1M.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onvCMZ(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_onvCMZ.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooqB2A(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_ooqB2A.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opGvHd(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1WhouvVKZFH94VXj9pa8v4szvfrBwXoBUj/parameter_opGvHd.tz'))
        self.assertEqual(expected, actual)
