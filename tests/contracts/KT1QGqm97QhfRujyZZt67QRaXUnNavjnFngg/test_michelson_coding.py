...
class MichelsonCodingTestKT1QGq(TestCase):
    ...
    def test_michelson_parse_parameter_ooFF3q(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_ooFF3q.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_ooFF3q.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooFF3q(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_ooFF3q.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_ooFF3q.json'), 
    ...
    def test_michelson_inverse_parameter_ooFF3q(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_ooFF3q.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_opPANC(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_opPANC.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_opPANC.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_opPANC(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_opPANC.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_opPANC.json'), 
    ...
    def test_michelson_inverse_parameter_opPANC(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_opPANC.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_onhymB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_onhymB.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_onhymB.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_onhymB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_onhymB.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_onhymB.json'), 
    ...
    def test_michelson_inverse_parameter_onhymB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QGqm97QhfRujyZZt67QRaXUnNavjnFngg/parameter_onhymB.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
