...
class MichelsonCodingTestKT1T6C(TestCase):
    ...
    def test_michelson_parse_code_KT1T6C(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1T6CDRQLRiFU5dszBZWWQwQc8aCbfwX3Mg/code_KT1T6C.tz'))
    ...
    def test_michelson_parse_storage_KT1T6C(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1T6CDRQLRiFU5dszBZWWQwQc8aCbfwX3Mg/storage_KT1T6C.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooQKSw(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1T6CDRQLRiFU5dszBZWWQwQc8aCbfwX3Mg/parameter_ooQKSw.tz'))
        self.assertEqual(expected, actual)
