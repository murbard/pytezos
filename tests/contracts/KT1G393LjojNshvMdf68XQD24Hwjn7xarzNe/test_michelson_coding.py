...
class MichelsonCodingTestKT1G39(TestCase):
    ...
    def test_michelson_parse_parameter_ooZ3nd(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooZ3nd.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooZ3nd.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooZ3nd(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooZ3nd.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooZ3nd.json'), 
    ...
    def test_michelson_inverse_parameter_ooZ3nd(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooZ3nd.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooLRQs(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooLRQs.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooLRQs.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooLRQs(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooLRQs.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooLRQs.json'), 
    ...
    def test_michelson_inverse_parameter_ooLRQs(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1G393LjojNshvMdf68XQD24Hwjn7xarzNe/parameter_ooLRQs.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
