...
class MichelsonCodingTestKT1DV3(TestCase):
    ...
    def test_michelson_parse_code_KT1DV3(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/code_KT1DV3.tz'))
    ...
    def test_michelson_parse_storage_KT1DV3(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/storage_KT1DV3.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo5gaT(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oo5gaT.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opPGAB(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_opPGAB.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ootr5F(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_ootr5F.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo64jf(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oo64jf.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onk5NH(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_onk5NH.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooc8Cj(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_ooc8Cj.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo9js3(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oo9js3.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooiH4t(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_ooiH4t.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_ooiH4t.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo28MJ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oo28MJ.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oo28MJ.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oowfZb(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oowfZb.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1DV3mNYRrdpSBzcsJMk9Zd9q43c3iNW9mW/parameter_oowfZb.tz'))
        self.assertEqual(expected, actual)
