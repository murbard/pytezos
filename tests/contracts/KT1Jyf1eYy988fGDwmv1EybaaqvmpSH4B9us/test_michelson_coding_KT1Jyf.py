...
class MichelsonCodingTestKT1Jyf(TestCase):
    ...
    def test_michelson_parse_code_KT1Jyf(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Jyf1eYy988fGDwmv1EybaaqvmpSH4B9us/code_KT1Jyf.tz'))
    ...
    def test_michelson_parse_storage_KT1Jyf(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Jyf1eYy988fGDwmv1EybaaqvmpSH4B9us/storage_KT1Jyf.tz'))
        self.assertEqual(expected, actual)
