...
class MichelsonCodingTestKT1Rbg(TestCase):
    ...
    def test_michelson_parse_code_KT1Rbg(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/code_KT1Rbg.tz'))
    ...
    def test_michelson_parse_storage_KT1Rbg(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/storage_KT1Rbg.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opPKEf(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opPKEf.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooADdh(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooADdh.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opDD3W(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opDD3W.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oovacQ(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_oovacQ.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooyq1S(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooyq1S.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opNXFv(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opNXFv.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooCpEk(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooCpEk.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo8Lks(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_oo8Lks.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_oo8Lks.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_oo8Lks(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_oo8Lks.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_oo8Lks.json'), 
    ...
    def test_michelson_inverse_parameter_oo8Lks(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_oo8Lks.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_opA1PY(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opA1PY.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opA1PY.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_opA1PY(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opA1PY.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opA1PY.json'), 
    ...
    def test_michelson_inverse_parameter_opA1PY(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_opA1PY.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooH2AZ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooH2AZ.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooH2AZ.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooH2AZ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooH2AZ.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooH2AZ.json'), 
    ...
    def test_michelson_inverse_parameter_ooH2AZ(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1RbgzW6RMPsjhrRRQWZ8fHTLWxW54JyxJm/parameter_ooH2AZ.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
