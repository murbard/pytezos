...
class MichelsonCodingTestKT1EwP(TestCase):
    ...
    def test_michelson_parse_code_KT1EwP(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1EwPxDNyx2y5NSEgKQNLzGSrwBab5Ay8yS/code_KT1EwP.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1EwPxDNyx2y5NSEgKQNLzGSrwBab5Ay8yS/code_KT1EwP.tz'))
    ...
    def test_michelson_parse_storage_KT1EwP(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1EwPxDNyx2y5NSEgKQNLzGSrwBab5Ay8yS/storage_KT1EwP.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1EwPxDNyx2y5NSEgKQNLzGSrwBab5Ay8yS/storage_KT1EwP.tz'))
        self.assertEqual(expected, actual)
