...
class MichelsonCodingTestKT1NV5(TestCase):
    ...
    def test_michelson_parse_parameter_oov9an(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_oov9an.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_oov9an.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_oov9an(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_oov9an.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_oov9an.json'), 
    ...
    def test_michelson_inverse_parameter_oov9an(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_oov9an.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ookFkf(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ookFkf.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ookFkf.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ookFkf(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ookFkf.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ookFkf.json'), 
    ...
    def test_michelson_inverse_parameter_ookFkf(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ookFkf.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooE67o(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ooE67o.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ooE67o.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooE67o(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ooE67o.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ooE67o.json'), 
    ...
    def test_michelson_inverse_parameter_ooE67o(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1NV5dYRFcd5hf5AQcgo6jodqmYpNc1hiv9/parameter_ooE67o.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
