...
class MichelsonCodingTestKT1PF3(TestCase):
    ...
    def test_michelson_parse_code_KT1PF3(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/code_KT1PF3.tz'))
    ...
    def test_michelson_parse_storage_KT1PF3(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/storage_KT1PF3.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oom6TD(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_oom6TD.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oog5Rn(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_oog5Rn.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oofw5X(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_oofw5X.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opTCKd(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_opTCKd.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooAUgp(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_ooAUgp.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooDrNz(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_ooDrNz.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onr1XX(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1PF3SoynnYGUw3diCjETSbTSEZ1LJMXK9F/parameter_onr1XX.tz'))
        self.assertEqual(expected, actual)
