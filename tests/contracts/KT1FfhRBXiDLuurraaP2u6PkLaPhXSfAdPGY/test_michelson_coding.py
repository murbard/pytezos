...
class MichelsonCodingTestKT1Ffh(TestCase):
    ...
    def test_michelson_parse_code_KT1Ffh(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/code_KT1Ffh.tz'))
    ...
    def test_michelson_parse_storage_KT1Ffh(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/storage_KT1Ffh.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo6ZHj(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_oo6ZHj.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooA6Vb(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooA6Vb.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oorUFL(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_oorUFL.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooExks(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooExks.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opBC7h(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_opBC7h.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooRry3(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooRry3.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onmeSo(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_onmeSo.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooV8cV(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooV8cV.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooV8cV.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooV8cV(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooV8cV.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooV8cV.json'), 
    ...
    def test_michelson_inverse_parameter_ooV8cV(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooV8cV.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_onhbfM(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_onhbfM.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_onhbfM.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_onhbfM(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_onhbfM.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_onhbfM.json'), 
    ...
    def test_michelson_inverse_parameter_onhbfM(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_onhbfM.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooZYTR(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooZYTR.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooZYTR.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooZYTR(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooZYTR.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooZYTR.json'), 
    ...
    def test_michelson_inverse_parameter_ooZYTR(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FfhRBXiDLuurraaP2u6PkLaPhXSfAdPGY/parameter_ooZYTR.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
