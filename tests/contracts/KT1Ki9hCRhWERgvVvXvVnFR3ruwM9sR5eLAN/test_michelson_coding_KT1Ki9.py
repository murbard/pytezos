...
class MichelsonCodingTestKT1Ki9(TestCase):
    ...
    def test_michelson_parse_code_KT1Ki9(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ki9hCRhWERgvVvXvVnFR3ruwM9sR5eLAN/code_KT1Ki9.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ki9hCRhWERgvVvXvVnFR3ruwM9sR5eLAN/code_KT1Ki9.tz'))
    ...
    def test_michelson_parse_storage_KT1Ki9(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ki9hCRhWERgvVvXvVnFR3ruwM9sR5eLAN/storage_KT1Ki9.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Ki9hCRhWERgvVvXvVnFR3ruwM9sR5eLAN/storage_KT1Ki9.tz'))
        self.assertEqual(expected, actual)
