...
class MichelsonCodingTestKT1FU7(TestCase):
    ...
    def test_michelson_parse_parameter_onqeTm(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_onqeTm.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_onqeTm.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_onqeTm(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_onqeTm.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_onqeTm.json'), 
    ...
    def test_michelson_inverse_parameter_onqeTm(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_onqeTm.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_opAtAi(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_opAtAi.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_opAtAi.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_opAtAi(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_opAtAi.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_opAtAi.json'), 
    ...
    def test_michelson_inverse_parameter_opAtAi(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_opAtAi.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)

    def test_michelson_parse_parameter_ooLns1(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_ooLns1.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_ooLns1.tz'))
        self.assertEqual(expected, actual)

    def test_michelson_format_parameter_ooLns1(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_ooLns1.tz')
        actual = micheline_to_michelson(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_ooLns1.json'), 
    ...
    def test_michelson_inverse_parameter_ooLns1(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1FU74GimCeEVRAEZGURb6TWU8jK1N6zFJy/parameter_ooLns1.json')
        actual = michelson_to_micheline(micheline_to_michelson(expected))
        self.assertEqual(expected, actual)
