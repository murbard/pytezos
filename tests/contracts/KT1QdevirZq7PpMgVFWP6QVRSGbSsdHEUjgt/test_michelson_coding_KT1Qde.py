...
class MichelsonCodingTestKT1Qde(TestCase):
    ...
    def test_michelson_parse_parameter_ooTYSp(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_ooTYSp.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_ooTYSp.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oovxpk(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_oovxpk.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_oovxpk.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooWRVq(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_ooWRVq.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_ooWRVq.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooDitX(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_ooDitX.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_ooDitX.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_oo7BsA(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_oo7BsA.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_oo7BsA.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onncXB(self):
        expected = get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_onncXB.json')
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1QdevirZq7PpMgVFWP6QVRSGbSsdHEUjgt/parameter_onncXB.tz'))
        self.assertEqual(expected, actual)
