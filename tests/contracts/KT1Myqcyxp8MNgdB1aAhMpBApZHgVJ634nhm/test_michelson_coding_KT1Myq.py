...
class MichelsonCodingTestKT1Myq(TestCase):
    ...
    def test_michelson_parse_code_KT1Myq(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/code_KT1Myq.tz'))
    ...
    def test_michelson_parse_storage_KT1Myq(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/storage_KT1Myq.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooZMtN(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_ooZMtN.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooGGqi(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_ooGGqi.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_opYTCv(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_opYTCv.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_op1CjT(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_op1CjT.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_onyJat(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_onyJat.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_ooPQUi(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_ooPQUi.tz'))
        self.assertEqual(expected, actual)
    ...
    def test_michelson_parse_parameter_op1KRF(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1Myqcyxp8MNgdB1aAhMpBApZHgVJ634nhm/parameter_op1KRF.tz'))
        self.assertEqual(expected, actual)
