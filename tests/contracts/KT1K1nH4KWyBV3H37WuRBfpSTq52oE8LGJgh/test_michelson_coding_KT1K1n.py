...
class MichelsonCodingTestKT1K1n(TestCase):
    ...
    def test_michelson_parse_code_KT1K1n(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1K1nH4KWyBV3H37WuRBfpSTq52oE8LGJgh/code_KT1K1n.tz'))
    ...
    def test_michelson_parse_storage_KT1K1n(self):
        ...
        actual = michelson_to_micheline(get_data(
            path='/home/mickey/pytezos/tests/contracts/KT1K1nH4KWyBV3H37WuRBfpSTq52oE8LGJgh/storage_KT1K1n.tz'))
        self.assertEqual(expected, actual)
