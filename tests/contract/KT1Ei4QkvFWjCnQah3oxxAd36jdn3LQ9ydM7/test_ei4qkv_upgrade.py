...
class MainnetOperationTestCaseEI4QKV(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'upgrade.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'upgrade'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_ei4qkv(self):
    ...
    def test_lazy_storage_ei4qkv(self):
