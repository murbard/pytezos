...
class MainnetContractTestCaseEI4QKV(TestCase):
    ...
    def test_parameter_type_ei4qkv(self):
    ...
    def test_entrypoints_ei4qkv(self):
    ...
    def test_storage_type_ei4qkv(self):
    ...
    def test_storage_encoding_ei4qkv(self):
