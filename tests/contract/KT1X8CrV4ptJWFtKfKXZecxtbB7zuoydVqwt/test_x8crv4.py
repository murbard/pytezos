...
class MainnetContractTestCaseX8CRV4(TestCase):
    ...
    def test_parameter_type_x8crv4(self):
    ...
    def test_entrypoints_x8crv4(self):
    ...
    def test_storage_type_x8crv4(self):
    ...
    def test_storage_encoding_x8crv4(self):
