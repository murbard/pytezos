...
class MainnetContractTestCaseNYQJME(TestCase):
    ...
    def test_parameter_type_nyqjme(self):
    ...
    def test_entrypoints_nyqjme(self):
    ...
    def test_storage_type_nyqjme(self):
    ...
    def test_storage_encoding_nyqjme(self):
