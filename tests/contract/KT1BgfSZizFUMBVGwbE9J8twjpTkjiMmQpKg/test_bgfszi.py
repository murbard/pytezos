...
class MainnetContractTestCaseBGFSZI(TestCase):
    ...
    def test_parameter_type_bgfszi(self):
    ...
    def test_entrypoints_bgfszi(self):
    ...
    def test_storage_type_bgfszi(self):
    ...
    def test_storage_encoding_bgfszi(self):
