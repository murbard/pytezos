...
class MainnetContractTestCaseTNWBXG(TestCase):
    ...
    def test_parameter_type_tnwbxg(self):
    ...
    def test_entrypoints_tnwbxg(self):
    ...
    def test_storage_type_tnwbxg(self):
    ...
    def test_storage_encoding_tnwbxg(self):
