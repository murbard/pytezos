...
class MainnetContractTestCaseANF9HT(TestCase):
    ...
    def test_parameter_type_anf9ht(self):
    ...
    def test_entrypoints_anf9ht(self):
    ...
    def test_storage_type_anf9ht(self):
    ...
    def test_storage_encoding_anf9ht(self):
