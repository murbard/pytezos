...
class MainnetContractTestCaseGALBSR(TestCase):
    ...
    def test_parameter_type_galbsr(self):
    ...
    def test_entrypoints_galbsr(self):
    ...
    def test_storage_type_galbsr(self):
    ...
    def test_storage_encoding_galbsr(self):
