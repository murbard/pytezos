...
class MainnetContractTestCaseEOFZBE(TestCase):
    ...
    def test_parameter_type_eofzbe(self):
    ...
    def test_entrypoints_eofzbe(self):
    ...
    def test_storage_type_eofzbe(self):
    ...
    def test_storage_encoding_eofzbe(self):
