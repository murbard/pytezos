...
class MainnetContractTestCaseFTKK4E(TestCase):
    ...
    def test_parameter_type_ftkk4e(self):
    ...
    def test_entrypoints_ftkk4e(self):
    ...
    def test_storage_type_ftkk4e(self):
    ...
    def test_storage_encoding_ftkk4e(self):
