...
class MainnetContractTestCaseVUXRH7(TestCase):
    ...
    def test_parameter_type_vuxrh7(self):
    ...
    def test_entrypoints_vuxrh7(self):
    ...
    def test_storage_type_vuxrh7(self):
    ...
    def test_storage_encoding_vuxrh7(self):
