...
class MainnetContractTestCaseAJPB7A(TestCase):
    ...
    def test_parameter_type_ajpb7a(self):
    ...
    def test_entrypoints_ajpb7a(self):
    ...
    def test_storage_type_ajpb7a(self):
    ...
    def test_storage_encoding_ajpb7a(self):
