...
class MainnetContractTestCaseRJPNMC(TestCase):
    ...
    def test_parameter_type_rjpnmc(self):
    ...
    def test_entrypoints_rjpnmc(self):
    ...
    def test_storage_type_rjpnmc(self):
    ...
    def test_storage_encoding_rjpnmc(self):
