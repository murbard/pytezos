...
class MainnetContractTestCaseBWB2QW(TestCase):
    ...
    def test_parameter_type_bwb2qw(self):
    ...
    def test_entrypoints_bwb2qw(self):
    ...
    def test_storage_type_bwb2qw(self):
    ...
    def test_storage_encoding_bwb2qw(self):
