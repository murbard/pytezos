...
class MainnetContractTestCaseCEXPH7(TestCase):
    ...
    def test_parameter_type_cexph7(self):
    ...
    def test_entrypoints_cexph7(self):
    ...
    def test_storage_type_cexph7(self):
    ...
    def test_storage_encoding_cexph7(self):
