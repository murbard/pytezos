...
class MainnetContractTestCaseUQSAAY(TestCase):
    ...
    def test_parameter_type_uqsaay(self):
    ...
    def test_entrypoints_uqsaay(self):
    ...
    def test_storage_type_uqsaay(self):
    ...
    def test_storage_encoding_uqsaay(self):
