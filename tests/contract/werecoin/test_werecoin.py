...
class MainnetContractTestCaseWERECOIN(TestCase):
    ...
    def test_parameter_type_werecoin(self):
    ...
    def test_entrypoints_werecoin(self):
    ...
    def test_storage_type_werecoin(self):
    ...
    def test_storage_encoding_werecoin(self):
