...
class MainnetOperationTestCaseWERECOIN(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'approve.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'approve'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_werecoin(self):
    ...
    def test_lazy_storage_werecoin(self):
