...
class MainnetContractTestCaseF25MTK(TestCase):
    ...
    def test_parameter_type_f25mtk(self):
    ...
    def test_entrypoints_f25mtk(self):
    ...
    def test_storage_type_f25mtk(self):
    ...
    def test_storage_encoding_f25mtk(self):
