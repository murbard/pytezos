...
class MainnetOperationTestCaseLNCYGG(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'set_administrator.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'set_administrator'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_lncygg(self):
    ...
    def test_lazy_storage_lncygg(self):
