...
class MainnetContractTestCaseLNCYGG(TestCase):
    ...
    def test_parameter_type_lncygg(self):
    ...
    def test_entrypoints_lncygg(self):
    ...
    def test_storage_type_lncygg(self):
    ...
    def test_storage_encoding_lncygg(self):
