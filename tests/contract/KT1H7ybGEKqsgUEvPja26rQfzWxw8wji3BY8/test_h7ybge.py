...
class MainnetContractTestCaseH7YBGE(TestCase):
    ...
    def test_parameter_type_h7ybge(self):
    ...
    def test_entrypoints_h7ybge(self):
    ...
    def test_storage_type_h7ybge(self):
    ...
    def test_storage_encoding_h7ybge(self):
