...
class MainnetContractTestCaseGBWIFG(TestCase):
    ...
    def test_parameter_type_gbwifg(self):
    ...
    def test_entrypoints_gbwifg(self):
    ...
    def test_storage_type_gbwifg(self):
    ...
    def test_storage_encoding_gbwifg(self):
