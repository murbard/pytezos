...
class MainnetContractTestCase9YNVU8(TestCase):
    ...
    def test_parameter_type_9ynvu8(self):
    ...
    def test_entrypoints_9ynvu8(self):
    ...
    def test_storage_type_9ynvu8(self):
    ...
    def test_storage_encoding_9ynvu8(self):
