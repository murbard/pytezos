...
class MainnetContractTestCaseL16VBM(TestCase):
    ...
    def test_parameter_type_l16vbm(self):
    ...
    def test_entrypoints_l16vbm(self):
    ...
    def test_storage_type_l16vbm(self):
    ...
    def test_storage_encoding_l16vbm(self):
