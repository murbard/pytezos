...
class MainnetContractTestCaseUBKWP8(TestCase):
    ...
    def test_parameter_type_ubkwp8(self):
    ...
    def test_entrypoints_ubkwp8(self):
    ...
    def test_storage_type_ubkwp8(self):
    ...
    def test_storage_encoding_ubkwp8(self):
