...
class MainnetContractTestCaseSGGPJC(TestCase):
    ...
    def test_parameter_type_sggpjc(self):
    ...
    def test_entrypoints_sggpjc(self):
    ...
    def test_storage_type_sggpjc(self):
    ...
    def test_storage_encoding_sggpjc(self):
