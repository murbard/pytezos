...
class MainnetOperationTestCaseRK6XUV(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'postExtract.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'postExtract'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_rk6xuv(self):
    ...
    def test_lazy_storage_rk6xuv(self):
