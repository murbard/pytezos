...
class MainnetContractTestCaseRK6XUV(TestCase):
    ...
    def test_parameter_type_rk6xuv(self):
    ...
    def test_entrypoints_rk6xuv(self):
    ...
    def test_storage_type_rk6xuv(self):
    ...
    def test_storage_encoding_rk6xuv(self):
