...
class MainnetContractTestCaseK5NPKP(TestCase):
    ...
    def test_parameter_type_k5npkp(self):
    ...
    def test_entrypoints_k5npkp(self):
    ...
    def test_storage_type_k5npkp(self):
    ...
    def test_storage_encoding_k5npkp(self):
