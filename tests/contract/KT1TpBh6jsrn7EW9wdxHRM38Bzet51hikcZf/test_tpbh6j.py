...
class MainnetContractTestCaseTPBH6J(TestCase):
    ...
    def test_parameter_type_tpbh6j(self):
    ...
    def test_entrypoints_tpbh6j(self):
    ...
    def test_storage_type_tpbh6j(self):
    ...
    def test_storage_encoding_tpbh6j(self):
