...
class MainnetOperationTestCaseXPTWSX(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'checkMember.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'checkMember'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_xptwsx(self):
    ...
    def test_lazy_storage_xptwsx(self):
