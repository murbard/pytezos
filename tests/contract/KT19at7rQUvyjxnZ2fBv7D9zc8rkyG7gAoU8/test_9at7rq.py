...
class MainnetContractTestCase9AT7RQ(TestCase):
    ...
    def test_parameter_type_9at7rq(self):
    ...
    def test_entrypoints_9at7rq(self):
    ...
    def test_storage_type_9at7rq(self):
    ...
    def test_storage_encoding_9at7rq(self):
