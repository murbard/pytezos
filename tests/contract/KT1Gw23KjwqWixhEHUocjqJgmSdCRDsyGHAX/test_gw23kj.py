...
class MainnetContractTestCaseGW23KJ(TestCase):
    ...
    def test_parameter_type_gw23kj(self):
    ...
    def test_entrypoints_gw23kj(self):
    ...
    def test_storage_type_gw23kj(self):
    ...
    def test_storage_encoding_gw23kj(self):
