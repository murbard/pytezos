...
class MainnetContractTestCaseM2GNG6(TestCase):
    ...
    def test_parameter_type_m2gng6(self):
    ...
    def test_entrypoints_m2gng6(self):
    ...
    def test_storage_type_m2gng6(self):
    ...
    def test_storage_encoding_m2gng6(self):
