...
class MainnetContractTestCaseT3MZ2R(TestCase):
    ...
    def test_parameter_type_t3mz2r(self):
    ...
    def test_entrypoints_t3mz2r(self):
    ...
    def test_storage_type_t3mz2r(self):
    ...
    def test_storage_encoding_t3mz2r(self):
