...
class MainnetOperationTestCaseUCPH3S(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update_meta.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update_meta'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_ucph3s(self):
