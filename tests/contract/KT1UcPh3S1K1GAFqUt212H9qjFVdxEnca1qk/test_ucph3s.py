...
class MainnetContractTestCaseUCPH3S(TestCase):
    ...
    def test_parameter_type_ucph3s(self):
    ...
    def test_entrypoints_ucph3s(self):
    ...
    def test_storage_type_ucph3s(self):
    ...
    def test_storage_encoding_ucph3s(self):
