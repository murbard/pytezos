...
class MainnetContractTestCaseECOO_WETZIKOIN(TestCase):
    ...
    def test_parameter_type_ecoo_wetzikoin(self):
    ...
    def test_entrypoints_ecoo_wetzikoin(self):
    ...
    def test_storage_type_ecoo_wetzikoin(self):
    ...
    def test_storage_encoding_ecoo_wetzikoin(self):
