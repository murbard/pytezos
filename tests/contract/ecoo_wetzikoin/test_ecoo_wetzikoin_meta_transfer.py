...
class MainnetOperationTestCaseECOO_WETZIKOIN(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'meta_transfer.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'meta_transfer'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_ecoo_wetzikoin(self):
    ...
    def test_lazy_storage_ecoo_wetzikoin(self):
