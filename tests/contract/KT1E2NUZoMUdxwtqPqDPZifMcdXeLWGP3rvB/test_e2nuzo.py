...
class MainnetContractTestCaseE2NUZO(TestCase):
    ...
    def test_parameter_type_e2nuzo(self):
    ...
    def test_entrypoints_e2nuzo(self):
    ...
    def test_storage_type_e2nuzo(self):
    ...
    def test_storage_encoding_e2nuzo(self):
