...
class MainnetOperationTestCaseE2NUZO(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'setAdministrator.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'setAdministrator'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_e2nuzo(self):
    ...
    def test_lazy_storage_e2nuzo(self):
