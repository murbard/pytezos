...
class MainnetOperationTestCase9GRXJR(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'main.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'main'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_9grxjr(self):
    ...
    def test_lazy_storage_9grxjr(self):
