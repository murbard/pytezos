...
class MainnetOperationTestCaseJQ8VJI(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'updateDelegator.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'updateDelegator'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_jq8vji(self):
    ...
    def test_lazy_storage_jq8vji(self):
