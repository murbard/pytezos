...
class MainnetContractTestCasePPOUVG(TestCase):
    ...
    def test_parameter_type_ppouvg(self):
    ...
    def test_entrypoints_ppouvg(self):
    ...
    def test_storage_type_ppouvg(self):
    ...
    def test_storage_encoding_ppouvg(self):
