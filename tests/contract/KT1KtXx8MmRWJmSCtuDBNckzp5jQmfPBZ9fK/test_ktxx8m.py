...
class MainnetContractTestCaseKTXX8M(TestCase):
    ...
    def test_parameter_type_ktxx8m(self):
    ...
    def test_entrypoints_ktxx8m(self):
    ...
    def test_storage_type_ktxx8m(self):
    ...
    def test_storage_encoding_ktxx8m(self):
