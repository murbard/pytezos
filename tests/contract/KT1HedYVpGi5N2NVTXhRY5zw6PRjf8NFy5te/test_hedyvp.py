...
class MainnetContractTestCaseHEDYVP(TestCase):
    ...
    def test_parameter_type_hedyvp(self):
    ...
    def test_entrypoints_hedyvp(self):
    ...
    def test_storage_type_hedyvp(self):
    ...
    def test_storage_encoding_hedyvp(self):
