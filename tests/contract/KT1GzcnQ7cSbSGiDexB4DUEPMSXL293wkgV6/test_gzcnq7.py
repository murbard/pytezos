...
class MainnetContractTestCaseGZCNQ7(TestCase):
    ...
    def test_parameter_type_gzcnq7(self):
    ...
    def test_entrypoints_gzcnq7(self):
    ...
    def test_storage_type_gzcnq7(self):
    ...
    def test_storage_encoding_gzcnq7(self):
