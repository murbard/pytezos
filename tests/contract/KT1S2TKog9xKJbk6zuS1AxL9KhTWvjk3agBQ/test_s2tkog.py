...
class MainnetContractTestCaseS2TKOG(TestCase):
    ...
    def test_parameter_type_s2tkog(self):
    ...
    def test_entrypoints_s2tkog(self):
    ...
    def test_storage_type_s2tkog(self):
    ...
    def test_storage_encoding_s2tkog(self):
