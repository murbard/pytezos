...
class MainnetOperationTestCaseS2TKOG(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'command.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'command'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_s2tkog(self):
    ...
    def test_lazy_storage_s2tkog(self):
