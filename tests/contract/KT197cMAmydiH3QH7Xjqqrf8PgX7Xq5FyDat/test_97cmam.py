...
class MainnetContractTestCase97CMAM(TestCase):
    ...
    def test_parameter_type_97cmam(self):
    ...
    def test_entrypoints_97cmam(self):
    ...
    def test_storage_type_97cmam(self):
    ...
    def test_storage_encoding_97cmam(self):
