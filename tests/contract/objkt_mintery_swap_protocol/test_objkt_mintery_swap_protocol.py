...
class MainnetContractTestCaseOBJKT_MINTERY_SWAP_PROTOCOL(TestCase):
    ...
    def test_parameter_type_objkt_mintery_swap_protocol(self):
    ...
    def test_entrypoints_objkt_mintery_swap_protocol(self):
    ...
    def test_storage_type_objkt_mintery_swap_protocol(self):
    ...
    def test_storage_encoding_objkt_mintery_swap_protocol(self):
