...
class MainnetContractTestCaseEX8LRD(TestCase):
    ...
    def test_parameter_type_ex8lrd(self):
    ...
    def test_entrypoints_ex8lrd(self):
    ...
    def test_storage_type_ex8lrd(self):
    ...
    def test_storage_encoding_ex8lrd(self):
