...
class MainnetContractTestCaseL7PKMB(TestCase):
    ...
    def test_parameter_type_l7pkmb(self):
    ...
    def test_entrypoints_l7pkmb(self):
    ...
    def test_storage_type_l7pkmb(self):
    ...
    def test_storage_encoding_l7pkmb(self):
