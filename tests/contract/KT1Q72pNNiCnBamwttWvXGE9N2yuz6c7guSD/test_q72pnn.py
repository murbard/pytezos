...
class MainnetContractTestCaseQ72PNN(TestCase):
    ...
    def test_parameter_type_q72pnn(self):
    ...
    def test_entrypoints_q72pnn(self):
    ...
    def test_storage_type_q72pnn(self):
    ...
    def test_storage_encoding_q72pnn(self):
