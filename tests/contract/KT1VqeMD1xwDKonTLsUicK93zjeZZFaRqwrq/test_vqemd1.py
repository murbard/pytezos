...
class MainnetContractTestCaseVQEMD1(TestCase):
    ...
    def test_parameter_type_vqemd1(self):
    ...
    def test_entrypoints_vqemd1(self):
    ...
    def test_storage_type_vqemd1(self):
    ...
    def test_storage_encoding_vqemd1(self):
