...
class MainnetContractTestCaseVRKTCZ(TestCase):
    ...
    def test_parameter_type_vrktcz(self):
    ...
    def test_entrypoints_vrktcz(self):
    ...
    def test_storage_type_vrktcz(self):
    ...
    def test_storage_encoding_vrktcz(self):
