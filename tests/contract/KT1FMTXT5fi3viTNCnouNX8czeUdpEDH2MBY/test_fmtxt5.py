...
class MainnetContractTestCaseFMTXT5(TestCase):
    ...
    def test_parameter_type_fmtxt5(self):
    ...
    def test_entrypoints_fmtxt5(self):
    ...
    def test_storage_type_fmtxt5(self):
    ...
    def test_storage_encoding_fmtxt5(self):
