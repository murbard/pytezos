...
class MainnetOperationTestCaseFMTXT5(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'do.json')) as f:
    ...
    def test_parameters_fmtxt5(self):
    ...
    def test_lazy_storage_fmtxt5(self):
