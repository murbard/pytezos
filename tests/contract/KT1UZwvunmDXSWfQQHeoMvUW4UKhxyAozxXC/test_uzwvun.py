...
class MainnetContractTestCaseUZWVUN(TestCase):
    ...
    def test_parameter_type_uzwvun(self):
    ...
    def test_entrypoints_uzwvun(self):
    ...
    def test_storage_type_uzwvun(self):
    ...
    def test_storage_encoding_uzwvun(self):
