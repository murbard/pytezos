...
class MainnetContractTestCaseVGXHLX(TestCase):
    ...
    def test_parameter_type_vgxhlx(self):
    ...
    def test_entrypoints_vgxhlx(self):
    ...
    def test_storage_type_vgxhlx(self):
    ...
    def test_storage_encoding_vgxhlx(self):
