...
class MainnetOperationTestCaseVGXHLX(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'create_delegate_contract.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'create_delegate_contract'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_vgxhlx(self):
    ...
    def test_lazy_storage_vgxhlx(self):
