...
class MainnetContractTestCaseACFS1M(TestCase):
    ...
    def test_parameter_type_acfs1m(self):
    ...
    def test_entrypoints_acfs1m(self):
    ...
    def test_storage_type_acfs1m(self):
    ...
    def test_storage_encoding_acfs1m(self):
