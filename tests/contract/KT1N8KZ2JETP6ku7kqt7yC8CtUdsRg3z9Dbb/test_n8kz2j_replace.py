...
class MainnetOperationTestCaseN8KZ2J(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'replace.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'replace'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_n8kz2j(self):
    ...
    def test_lazy_storage_n8kz2j(self):
