...
class MainnetContractTestCaseDEXTER_TZBTC_XTZ(TestCase):
    ...
    def test_parameter_type_dexter_tzbtc_xtz(self):
    ...
    def test_entrypoints_dexter_tzbtc_xtz(self):
    ...
    def test_storage_type_dexter_tzbtc_xtz(self):
    ...
    def test_storage_encoding_dexter_tzbtc_xtz(self):
