...
class MainnetOperationTestCaseJNU6TH(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'setAllowTransferFrom.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'setAllowTransferFrom'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_jnu6th(self):
    ...
    def test_lazy_storage_jnu6th(self):
