...
class MainnetContractTestCaseJNU6TH(TestCase):
    ...
    def test_parameter_type_jnu6th(self):
    ...
    def test_entrypoints_jnu6th(self):
    ...
    def test_storage_type_jnu6th(self):
    ...
    def test_storage_encoding_jnu6th(self):
