...
class MainnetContractTestCaseH28IIE(TestCase):
    ...
    def test_parameter_type_h28iie(self):
    ...
    def test_entrypoints_h28iie(self):
    ...
    def test_storage_type_h28iie(self):
    ...
    def test_storage_encoding_h28iie(self):
