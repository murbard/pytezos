...
class MainnetContractTestCaseMWPEOE(TestCase):
    ...
    def test_parameter_type_mwpeoe(self):
    ...
    def test_entrypoints_mwpeoe(self):
    ...
    def test_storage_type_mwpeoe(self):
    ...
    def test_storage_encoding_mwpeoe(self):
