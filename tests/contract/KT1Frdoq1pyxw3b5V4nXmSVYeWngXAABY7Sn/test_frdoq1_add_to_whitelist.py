...
class MainnetOperationTestCaseFRDOQ1(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'add_to_whitelist.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'add_to_whitelist'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_frdoq1(self):
    ...
    def test_lazy_storage_frdoq1(self):
