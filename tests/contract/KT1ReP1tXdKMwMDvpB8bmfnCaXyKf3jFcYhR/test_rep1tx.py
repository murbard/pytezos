...
class MainnetContractTestCaseREP1TX(TestCase):
    ...
    def test_parameter_type_rep1tx(self):
    ...
    def test_entrypoints_rep1tx(self):
    ...
    def test_storage_type_rep1tx(self):
    ...
    def test_storage_encoding_rep1tx(self):
