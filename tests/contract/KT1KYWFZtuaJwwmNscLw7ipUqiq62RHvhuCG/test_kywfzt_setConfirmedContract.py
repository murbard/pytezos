...
class MainnetOperationTestCaseKYWFZT(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'setConfirmedContract.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'setConfirmedContract'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_kywfzt(self):
    ...
    def test_lazy_storage_kywfzt(self):
