...
class MainnetContractTestCaseKYWFZT(TestCase):
    ...
    def test_parameter_type_kywfzt(self):
    ...
    def test_entrypoints_kywfzt(self):
    ...
    def test_storage_type_kywfzt(self):
    ...
    def test_storage_encoding_kywfzt(self):
