...
class MainnetContractTestCasePDHB2T(TestCase):
    ...
    def test_parameter_type_pdhb2t(self):
    ...
    def test_entrypoints_pdhb2t(self):
    ...
    def test_storage_type_pdhb2t(self):
    ...
    def test_storage_encoding_pdhb2t(self):
