...
class MainnetContractTestCaseFGQ1V3(TestCase):
    ...
    def test_parameter_type_fgq1v3(self):
    ...
    def test_entrypoints_fgq1v3(self):
    ...
    def test_storage_type_fgq1v3(self):
    ...
    def test_storage_encoding_fgq1v3(self):
