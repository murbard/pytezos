...
class MainnetContractTestCaseFV5XCO(TestCase):
    ...
    def test_parameter_type_fv5xco(self):
    ...
    def test_entrypoints_fv5xco(self):
    ...
    def test_storage_type_fv5xco(self):
    ...
    def test_storage_encoding_fv5xco(self):
