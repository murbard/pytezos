...
class MainnetContractTestCaseTEZOS_ISRAEL_AND_MADFISH_SOLUTIONS_WORKSHOP_CERTIFICATE(TestCase):
    ...
    def test_parameter_type_tezos_israel_and_madfish_solutions_workshop_certificate(self):
    ...
    def test_entrypoints_tezos_israel_and_madfish_solutions_workshop_certificate(self):
    ...
    def test_storage_type_tezos_israel_and_madfish_solutions_workshop_certificate(self):
    ...
    def test_storage_encoding_tezos_israel_and_madfish_solutions_workshop_certificate(self):
