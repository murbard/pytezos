...
class MainnetContractTestCaseNMOOFG(TestCase):
    ...
    def test_parameter_type_nmoofg(self):
    ...
    def test_entrypoints_nmoofg(self):
    ...
    def test_storage_type_nmoofg(self):
    ...
    def test_storage_encoding_nmoofg(self):
