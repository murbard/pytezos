...
class MainnetContractTestCaseDVEC3R(TestCase):
    ...
    def test_parameter_type_dvec3r(self):
    ...
    def test_entrypoints_dvec3r(self):
    ...
    def test_storage_type_dvec3r(self):
    ...
    def test_storage_encoding_dvec3r(self):
