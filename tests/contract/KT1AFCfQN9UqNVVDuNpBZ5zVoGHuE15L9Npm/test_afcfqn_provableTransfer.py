...
class MainnetOperationTestCaseAFCFQN(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'provableTransfer.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'provableTransfer'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_afcfqn(self):
    ...
    def test_lazy_storage_afcfqn(self):
