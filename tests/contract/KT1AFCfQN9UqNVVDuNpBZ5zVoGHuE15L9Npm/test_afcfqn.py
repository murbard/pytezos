...
class MainnetContractTestCaseAFCFQN(TestCase):
    ...
    def test_parameter_type_afcfqn(self):
    ...
    def test_entrypoints_afcfqn(self):
    ...
    def test_storage_type_afcfqn(self):
    ...
    def test_storage_encoding_afcfqn(self):
