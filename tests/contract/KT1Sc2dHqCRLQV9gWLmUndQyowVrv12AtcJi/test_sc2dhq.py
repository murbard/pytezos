...
class MainnetContractTestCaseSC2DHQ(TestCase):
    ...
    def test_parameter_type_sc2dhq(self):
    ...
    def test_entrypoints_sc2dhq(self):
    ...
    def test_storage_type_sc2dhq(self):
    ...
    def test_storage_encoding_sc2dhq(self):
