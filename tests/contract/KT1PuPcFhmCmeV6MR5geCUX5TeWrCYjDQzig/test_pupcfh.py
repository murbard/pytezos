...
class MainnetContractTestCasePUPCFH(TestCase):
    ...
    def test_parameter_type_pupcfh(self):
    ...
    def test_entrypoints_pupcfh(self):
    ...
    def test_storage_type_pupcfh(self):
    ...
    def test_storage_encoding_pupcfh(self):
