...
class MainnetOperationTestCasePUPCFH(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'createProposal.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'createProposal'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_pupcfh(self):
    ...
    def test_lazy_storage_pupcfh(self):
