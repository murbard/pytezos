...
class MainnetContractTestCaseHQGQDA(TestCase):
    ...
    def test_parameter_type_hqgqda(self):
    ...
    def test_entrypoints_hqgqda(self):
    ...
    def test_storage_type_hqgqda(self):
    ...
    def test_storage_encoding_hqgqda(self):
