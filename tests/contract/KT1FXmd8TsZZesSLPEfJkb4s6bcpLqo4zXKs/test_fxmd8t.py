...
class MainnetContractTestCaseFXMD8T(TestCase):
    ...
    def test_parameter_type_fxmd8t(self):
    ...
    def test_entrypoints_fxmd8t(self):
    ...
    def test_storage_type_fxmd8t(self):
    ...
    def test_storage_encoding_fxmd8t(self):
