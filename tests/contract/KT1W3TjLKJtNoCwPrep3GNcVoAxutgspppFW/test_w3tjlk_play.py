...
class MainnetOperationTestCaseW3TJLK(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'play.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'play'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_w3tjlk(self):
    ...
    def test_lazy_storage_w3tjlk(self):
