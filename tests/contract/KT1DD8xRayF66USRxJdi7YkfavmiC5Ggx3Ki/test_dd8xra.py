...
class MainnetContractTestCaseDD8XRA(TestCase):
    ...
    def test_parameter_type_dd8xra(self):
    ...
    def test_entrypoints_dd8xra(self):
    ...
    def test_storage_type_dd8xra(self):
    ...
    def test_storage_encoding_dd8xra(self):
