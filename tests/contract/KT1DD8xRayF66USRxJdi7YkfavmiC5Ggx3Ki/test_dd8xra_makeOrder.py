...
class MainnetOperationTestCaseDD8XRA(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'makeOrder.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'makeOrder'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_dd8xra(self):
    ...
    def test_lazy_storage_dd8xra(self):
