...
class MainnetContractTestCaseJGND55(TestCase):
    ...
    def test_parameter_type_jgnd55(self):
    ...
    def test_entrypoints_jgnd55(self):
    ...
    def test_storage_type_jgnd55(self):
    ...
    def test_storage_encoding_jgnd55(self):
