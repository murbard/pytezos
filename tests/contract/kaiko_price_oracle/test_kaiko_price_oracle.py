...
class MainnetContractTestCaseKAIKO_PRICE_ORACLE(TestCase):
    ...
    def test_parameter_type_kaiko_price_oracle(self):
    ...
    def test_entrypoints_kaiko_price_oracle(self):
    ...
    def test_storage_type_kaiko_price_oracle(self):
    ...
    def test_storage_encoding_kaiko_price_oracle(self):
