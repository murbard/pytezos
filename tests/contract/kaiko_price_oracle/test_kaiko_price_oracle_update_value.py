...
class MainnetOperationTestCaseKAIKO_PRICE_ORACLE(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update_value.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update_value'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_kaiko_price_oracle(self):
    ...
    def test_lazy_storage_kaiko_price_oracle(self):
