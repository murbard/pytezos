...
class MainnetContractTestCaseLYHDYN(TestCase):
    ...
    def test_parameter_type_lyhdyn(self):
    ...
    def test_entrypoints_lyhdyn(self):
    ...
    def test_storage_type_lyhdyn(self):
    ...
    def test_storage_encoding_lyhdyn(self):
