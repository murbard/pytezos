...
class MainnetContractTestCaseFYOPOD(TestCase):
    ...
    def test_parameter_type_fyopod(self):
    ...
    def test_entrypoints_fyopod(self):
    ...
    def test_storage_type_fyopod(self):
    ...
    def test_storage_encoding_fyopod(self):
