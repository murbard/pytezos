...
class MainnetContractTestCaseSQPIPE(TestCase):
    ...
    def test_parameter_type_sqpipe(self):
    ...
    def test_entrypoints_sqpipe(self):
    ...
    def test_storage_type_sqpipe(self):
    ...
    def test_storage_encoding_sqpipe(self):
