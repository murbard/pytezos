...
class MainnetContractTestCaseNH9PCO(TestCase):
    ...
    def test_parameter_type_nh9pco(self):
    ...
    def test_entrypoints_nh9pco(self):
    ...
    def test_storage_type_nh9pco(self):
    ...
    def test_storage_encoding_nh9pco(self):
