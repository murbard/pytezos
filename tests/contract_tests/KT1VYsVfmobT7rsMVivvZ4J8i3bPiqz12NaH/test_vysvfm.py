...
class MainnetContractTestCaseVYSVFM(TestCase):
    ...
    def test_parameter_type_vysvfm(self):
    ...
    def test_entrypoints_vysvfm(self):
    ...
    def test_storage_type_vysvfm(self):
    ...
    def test_storage_encoding_vysvfm(self):
