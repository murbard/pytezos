...
class MainnetContractTestCaseWEKKOD(TestCase):
    ...
    def test_parameter_type_wekkod(self):
    ...
    def test_entrypoints_wekkod(self):
    ...
    def test_storage_type_wekkod(self):
    ...
    def test_storage_encoding_wekkod(self):
