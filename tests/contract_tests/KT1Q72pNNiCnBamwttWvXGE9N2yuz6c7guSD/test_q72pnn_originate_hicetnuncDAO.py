...
class MainnetOperationTestCaseQ72PNN(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'originate_hicetnuncDAO.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'originate_hicetnuncDAO'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_q72pnn(self):
    ...
    def test_lazy_storage_q72pnn(self):
