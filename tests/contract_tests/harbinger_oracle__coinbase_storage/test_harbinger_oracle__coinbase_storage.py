...
class MainnetContractTestCaseHARBINGER_ORACLE__COINBASE_STORAGE(TestCase):
    ...
    def test_entrypoints_harbinger_oracle__coinbase_storage(self):
    ...
    def test_storage_encoding_harbinger_oracle__coinbase_storage(self):
