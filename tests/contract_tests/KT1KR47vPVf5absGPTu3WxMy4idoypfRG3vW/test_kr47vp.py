...
class MainnetContractTestCaseKR47VP(TestCase):
    ...
    def test_parameter_type_kr47vp(self):
    ...
    def test_entrypoints_kr47vp(self):
    ...
    def test_storage_type_kr47vp(self):
    ...
    def test_storage_encoding_kr47vp(self):
