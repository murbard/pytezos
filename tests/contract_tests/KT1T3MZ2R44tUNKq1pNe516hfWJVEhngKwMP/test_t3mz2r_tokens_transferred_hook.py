...
class MainnetOperationTestCaseT3MZ2R(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'tokens_transferred_hook.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'tokens_transferred_hook'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_t3mz2r(self):
    ...
    def test_lazy_storage_t3mz2r(self):
