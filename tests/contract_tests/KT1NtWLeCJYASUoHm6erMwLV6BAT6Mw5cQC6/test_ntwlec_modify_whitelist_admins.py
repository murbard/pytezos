...
class MainnetOperationTestCaseNTWLEC(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'modify_whitelist_admins.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'modify_whitelist_admins'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_ntwlec(self):
    ...
    def test_lazy_storage_ntwlec(self):
