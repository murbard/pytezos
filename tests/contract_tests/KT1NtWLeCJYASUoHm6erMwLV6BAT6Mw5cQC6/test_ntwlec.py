...
class MainnetContractTestCaseNTWLEC(TestCase):
    ...
    def test_parameter_type_ntwlec(self):
    ...
    def test_entrypoints_ntwlec(self):
    ...
    def test_storage_type_ntwlec(self):
    ...
    def test_storage_encoding_ntwlec(self):
