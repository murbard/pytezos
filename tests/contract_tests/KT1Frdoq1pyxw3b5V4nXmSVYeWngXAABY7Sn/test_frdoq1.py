...
class MainnetContractTestCaseFRDOQ1(TestCase):
    ...
    def test_parameter_type_frdoq1(self):
    ...
    def test_entrypoints_frdoq1(self):
    ...
    def test_storage_type_frdoq1(self):
    ...
    def test_storage_encoding_frdoq1(self):
