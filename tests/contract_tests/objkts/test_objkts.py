...
class MainnetContractTestCaseOBJKTS(TestCase):
    ...
    def test_parameter_type_objkts(self):
    ...
    def test_entrypoints_objkts(self):
    ...
    def test_storage_type_objkts(self):
    ...
    def test_storage_encoding_objkts(self):
