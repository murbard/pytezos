...
class MainnetContractTestCaseXPTWSX(TestCase):
    ...
    def test_parameter_type_xptwsx(self):
    ...
    def test_entrypoints_xptwsx(self):
    ...
    def test_storage_type_xptwsx(self):
    ...
    def test_storage_encoding_xptwsx(self):
