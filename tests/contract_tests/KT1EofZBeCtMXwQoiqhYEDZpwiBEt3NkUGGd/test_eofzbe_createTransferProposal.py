...
class MainnetOperationTestCaseEOFZBE(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'createTransferProposal.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'createTransferProposal'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_eofzbe(self):
    ...
    def test_lazy_storage_eofzbe(self):
