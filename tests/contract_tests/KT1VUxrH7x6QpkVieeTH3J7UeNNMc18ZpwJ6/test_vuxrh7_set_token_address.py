...
class MainnetOperationTestCaseVUXRH7(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'set_token_address.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'set_token_address'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_vuxrh7(self):
    ...
    def test_lazy_storage_vuxrh7(self):
