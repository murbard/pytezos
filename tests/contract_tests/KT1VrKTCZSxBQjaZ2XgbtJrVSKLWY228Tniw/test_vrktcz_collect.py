...
class MainnetOperationTestCaseVRKTCZ(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'collect.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'collect'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_vrktcz(self):
    ...
    def test_lazy_storage_vrktcz(self):
