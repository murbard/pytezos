...
class MainnetOperationTestCaseH7YBGE(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'call_upgrade.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'call_upgrade'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_h7ybge(self):
    ...
    def test_lazy_storage_h7ybge(self):
