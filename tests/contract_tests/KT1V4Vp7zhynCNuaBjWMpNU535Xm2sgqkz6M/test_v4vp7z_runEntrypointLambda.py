...
class MainnetOperationTestCaseV4VP7Z(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'runEntrypointLambda.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'runEntrypointLambda'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_v4vp7z(self):
    ...
    def test_lazy_storage_v4vp7z(self):
