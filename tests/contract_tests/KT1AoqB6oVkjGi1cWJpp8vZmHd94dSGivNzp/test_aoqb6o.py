...
class MainnetContractTestCaseAOQB6O(TestCase):
    ...
    def test_parameter_type_aoqb6o(self):
    ...
    def test_entrypoints_aoqb6o(self):
    ...
    def test_storage_type_aoqb6o(self):
    ...
    def test_storage_encoding_aoqb6o(self):
