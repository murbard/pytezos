...
class MainnetContractTestCaseQRXRDK(TestCase):
    ...
    def test_parameter_type_qrxrdk(self):
    ...
    def test_entrypoints_qrxrdk(self):
    ...
    def test_storage_type_qrxrdk(self):
    ...
    def test_storage_encoding_qrxrdk(self):
