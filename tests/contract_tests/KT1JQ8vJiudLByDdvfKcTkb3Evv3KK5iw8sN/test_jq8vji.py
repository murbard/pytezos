...
class MainnetContractTestCaseJQ8VJI(TestCase):
    ...
    def test_parameter_type_jq8vji(self):
    ...
    def test_entrypoints_jq8vji(self):
    ...
    def test_storage_type_jq8vji(self):
    ...
    def test_storage_encoding_jq8vji(self):
