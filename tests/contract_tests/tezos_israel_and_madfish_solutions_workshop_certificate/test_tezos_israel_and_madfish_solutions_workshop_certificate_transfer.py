...
class MainnetOperationTestCaseTEZOS_ISRAEL_AND_MADFISH_SOLUTIONS_WORKSHOP_CERTIFICATE(TestCase):
    ...
    def test_parameters_tezos_israel_and_madfish_solutions_workshop_certificate(self):
    ...
    def test_lazy_storage_tezos_israel_and_madfish_solutions_workshop_certificate(self):
