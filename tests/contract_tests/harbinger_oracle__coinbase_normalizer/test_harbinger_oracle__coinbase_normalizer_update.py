...
class MainnetOperationTestCaseHARBINGER_ORACLE__COINBASE_NORMALIZER(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_harbinger_oracle__coinbase_normalizer(self):
    ...
    def test_lazy_storage_harbinger_oracle__coinbase_normalizer(self):
