...
class MainnetOperationTestCaseEXDNHE(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'notarizeDocument.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'notarizeDocument'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_exdnhe(self):
    ...
    def test_lazy_storage_exdnhe(self):
