...
class MainnetOperationTestCaseHQGQDA(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'vest.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'vest'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_hqgqda(self):
    ...
    def test_lazy_storage_hqgqda(self):
