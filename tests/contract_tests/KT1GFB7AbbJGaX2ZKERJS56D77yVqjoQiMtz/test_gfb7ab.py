...
class MainnetContractTestCaseGFB7AB(TestCase):
    ...
    def test_parameter_type_gfb7ab(self):
    ...
    def test_entrypoints_gfb7ab(self):
    ...
    def test_storage_type_gfb7ab(self):
    ...
    def test_storage_encoding_gfb7ab(self):
