...
class MainnetContractTestCaseOROPOCKET_XTZ_GOLD(TestCase):
    ...
    def test_parameter_type_oropocket_xtz_gold(self):
    ...
    def test_entrypoints_oropocket_xtz_gold(self):
    ...
    def test_storage_type_oropocket_xtz_gold(self):
    ...
    def test_storage_encoding_oropocket_xtz_gold(self):
