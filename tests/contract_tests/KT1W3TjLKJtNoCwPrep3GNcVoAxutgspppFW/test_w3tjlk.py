...
class MainnetContractTestCaseW3TJLK(TestCase):
    ...
    def test_parameter_type_w3tjlk(self):
    ...
    def test_entrypoints_w3tjlk(self):
    ...
    def test_storage_type_w3tjlk(self):
    ...
    def test_storage_encoding_w3tjlk(self):
