...
class MainnetOperationTestCaseOBJKT_MINTERY_SWAP_PROTOCOL(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'swap_objkt.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'swap_objkt'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_objkt_mintery_swap_protocol(self):
    ...
    def test_lazy_storage_objkt_mintery_swap_protocol(self):
