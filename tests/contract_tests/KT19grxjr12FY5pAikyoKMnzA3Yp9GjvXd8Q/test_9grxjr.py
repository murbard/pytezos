...
class MainnetContractTestCase9GRXJR(TestCase):
    ...
    def test_parameter_type_9grxjr(self):
    ...
    def test_entrypoints_9grxjr(self):
    ...
    def test_storage_type_9grxjr(self):
    ...
    def test_storage_encoding_9grxjr(self):
