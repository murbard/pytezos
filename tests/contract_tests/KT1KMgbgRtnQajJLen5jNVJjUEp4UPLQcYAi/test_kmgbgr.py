...
class MainnetContractTestCaseKMGBGR(TestCase):
    ...
    def test_parameter_type_kmgbgr(self):
    ...
    def test_entrypoints_kmgbgr(self):
    ...
    def test_storage_type_kmgbgr(self):
    ...
    def test_storage_encoding_kmgbgr(self):
