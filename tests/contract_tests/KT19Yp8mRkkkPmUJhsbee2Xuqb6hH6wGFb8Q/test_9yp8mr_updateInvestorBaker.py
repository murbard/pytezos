...
class MainnetOperationTestCase9YP8MR(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'updateInvestorBaker.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'updateInvestorBaker'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_9yp8mr(self):
    ...
    def test_lazy_storage_9yp8mr(self):
