...
class MainnetOperationTestCaseCEXPH7(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'set_delegate_node.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'set_delegate_node'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_cexph7(self):
    ...
    def test_lazy_storage_cexph7(self):
