...
class MainnetOperationTestCaseGZCNQ7(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'modifyTokenTotalSupply.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'modifyTokenTotalSupply'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_gzcnq7(self):
    ...
    def test_lazy_storage_gzcnq7(self):
