...
class MainnetContractTestCaseWXTZ(TestCase):
    ...
    def test_parameter_type_wxtz(self):
    ...
    def test_entrypoints_wxtz(self):
    ...
    def test_storage_type_wxtz(self):
    ...
    def test_storage_encoding_wxtz(self):
